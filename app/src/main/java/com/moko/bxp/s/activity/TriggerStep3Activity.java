 ...
 * @des: 配置触发前的一些参数
 */
public class TriggerStep3Activity extends BaseActivity<ActivityTriggerStep3Binding> {
    private int slot;
    ...
    @Override
    protected ActivityTriggerStep3Binding getViewBinding() {
        return ActivityTriggerStep3Binding.inflate(getLayoutInflater());
    }
